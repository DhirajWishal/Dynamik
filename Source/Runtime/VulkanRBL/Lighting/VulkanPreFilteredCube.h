...
namespace Backend
{
	...
	*/
	...
	public:
		...
		virtual void initialize(RCoreObject* pCoreObject, REnvironmentEntity* pEnvironmentEntity, DMKExtent2D dimentions, DMKFormat format = DMKFormat::DMK_FORMAT_RGBA_16_SF32) override final;
