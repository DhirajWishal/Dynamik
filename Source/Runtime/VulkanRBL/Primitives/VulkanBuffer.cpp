...
namespace Backend
{
	void VulkanBuffer::initialize(RCoreObject* pCoreObject, RBufferType eType, UI64 uSize, RResourceMemoryType memoryType)
	{
		...
		switch (eType)
		{
		case RBufferType::BUFFER_TYPE_STAGGING:
			bufferInfo.usage = VK_BUFFER_USAGE_TRANSFER_SRC_BIT | VK_BUFFER_USAGE_TRANSFER_DST_BIT;
			break;
		case RBufferType::BUFFER_TYPE_VERTEX:
			bufferInfo.usage = VK_BUFFER_USAGE_VERTEX_BUFFER_BIT | VK_BUFFER_USAGE_TRANSFER_DST_BIT;
			break;
		case RBufferType::BUFFER_TYPE_INDEX:
			bufferInfo.usage = VK_BUFFER_USAGE_INDEX_BUFFER_BIT | VK_BUFFER_USAGE_TRANSFER_DST_BIT;
			break;
		case RBufferType::BUFFER_TYPE_UNIFORM:
			bufferInfo.usage = VK_BUFFER_USAGE_UNIFORM_BUFFER_BIT | VK_BUFFER_USAGE_TRANSFER_DST_BIT;
			break;
		case RBufferType::BUFFER_TYPE_INDIRECT:
