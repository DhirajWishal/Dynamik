...
struct ImFontConfig
{
    ...
    const ImWchar*  GlyphRanges;            // NULL     // Pointer to a user-provided list of Unicode range (2 value per range, values are inclusive, zero-terminated list). THE std::vector DATA NEEDS TO PERSIST AS LONG AS THE FONT IS ALIVE.
