...
namespace DMK
{
	namespace GraphicsCore
	{
		namespace VulkanBackend
		{
			...
			GDevice* VulkanBackendInstance::CreateDeviceObject(DeviceInitInfo initInfo)
			{
				// Allocate the device.
			...
			void VulkanBackendInstance::DestroyDevice(GDevice* pDevice)
			{
				// Terminate the device.
				pDevice->Terminate();

				// Deallocate the Vulkan Device.
				delete pDevice->Inherit<VulkanDevice>();
			}
