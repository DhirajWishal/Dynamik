...
namespace DMK
{
	...
	{
		void IndexBuffer::Initialize(const VulkanDevice& vDevice, UI64 size)
		{
		...
		void* IndexBuffer::MapMemory(const VulkanDevice& vDevice, UI64 size, UI64 offset)
		{
		...
		void IndexBuffer::UnmapMemory(const VulkanDevice& vDevice)
		{
