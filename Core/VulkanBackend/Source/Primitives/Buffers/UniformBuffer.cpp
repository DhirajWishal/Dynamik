...
namespace DMK
{
	...
	{
		void UniformBuffer::Initialize(GraphicsCore::Device* pDevice, UI64 size)
		{
		...
		void* UniformBuffer::MapMemory(GraphicsCore::Device* pDevice, UI64 size, UI64 offset)
		{
		...
		void UniformBuffer::UnmapMemory(GraphicsCore::Device* pDevice)
		{
