...
#include "VulkanBackend/Primitives/Buffers/VertexBuffer.h"
...
namespace DMK
{
	...
	{
		void VertexBuffer::Initialize(GraphicsCore::Device* pDevice, UI64 size)
		{
			vBuffer = CreateBuffer(pDevice->Derive<VulkanDevice>()->GetLogicalDevice(), size, VK_BUFFER_USAGE_VERTEX_BUFFER_BIT | VK_BUFFER_USAGE_TRANSFER_DST_BIT);
		...
		void* VertexBuffer::MapMemory(GraphicsCore::Device* pDevice, UI64 size, UI64 offset)
		{
		...
		void VertexBuffer::UnmapMemory(GraphicsCore::Device* pDevice)
		{
