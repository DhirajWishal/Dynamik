...
/**
 * Dynamik Data Types.
 * This file contains all the necessary data types and enums used in the Dynamik.
 */
...
{
	/**
	 * This contains all the virtual data types for Dynamik.
	 */
	...
	/**
	 * This contains all the formats supported by the Dynamik.
	 * R = Red,
	 * G = Green,
	 * B = Blue,
	 * A = Alpha
	...
	enum class Format : UI32 {
		...
		FORMAT_A2R10G10B10_UNORMAL_PACK32,
		FORMAT_A2R10G10B10_SNORMAL_PACK32,
		...
		FORMAT_A2B10G10R10_UNORMAL_PACK32,
		FORMAT_A2B10G10R10_SNORMAL_PACK32,
