...
namespace DMK
{
	 ...
	 */
	DMK_FORCEINLINE UI64 GetPointerAsInteger(const void* pointer)
	{
		return reinterpret_cast<UI64>(pointer);
	}
	...
	{
		return reinterpret_cast<void*>(reinterpret_cast<UI64>(pointer) + byteCount);
	}
