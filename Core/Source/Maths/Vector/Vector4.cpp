...
namespace DMK
{
		...
		: x(0.0f), y(0.0f), z(0.0f), w(0.0f)
	{
		...
		MemoryFunctions::MoveData(this, static_cast<const void*>(list.begin()), list.size() * sizeof(float));
	}

	Vector4::Vector4(const float* ptr)
		: x(0.0f), y(0.0f), z(0.0f), w(0.0f)
	{
		MemoryFunctions::MoveData(this, static_cast<const void*>(ptr), sizeof(float) * 4);
	}
