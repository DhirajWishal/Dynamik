...
namespace DMK
{
...
#endif // DMK_DEBUG
			StaticAllocator<BYTE>::RawDeallocate(static_cast<BYTE*>(_address.second), 0);
		}
	}
	...
	{
		StaticAllocator<BYTE>::RawDeallocate(static_cast<BYTE*>(location), size, alignment, offset);
