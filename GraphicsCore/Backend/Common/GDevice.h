...
#include "GraphicsCore/Backend/Objects/CommandBuffer.h"
...
namespace DMK
{
	namespace GraphicsCore
	{
		...
		struct DeviceInitInfo {
			const Char* pTitle = TEXT("Dynamik");	// The title of the display/ window.
		...
		public:
			 ...
			 */
			virtual std::vector<CommandBuffer*> CreateCommandBuffers(CommandBufferLevel level, UI32 bufferCount) { return std::vector<CommandBuffer*>(); }
			 ...
			 */
			virtual void SubmitCommands(std::vector<CommandBuffer*> pCommands) {}
