...
namespace Dynamik 
{
    ...
    */
    DMK_ALIGN class DMK_API DMKSceneComponent : public DMKGameComponent {
    public:
    ...
    */
    DMK_ALIGN class DMK_API DMKInternalSceneComponent : public DMKSceneComponent {
    public:
    ...
    */
    DMK_ALIGN class DMK_API DMKExternalSceneComponent : public DMKSceneComponent {
    public:
