...
namespace Dynamik
{
	...
	public:
		...
		void set(TYPE&& value) { StaticAllocator<TYPE>::set(myPointer, (TYPE&&)value); }
	...
	public:
		 ...
		 */
		UI64 operator+(const POINTER<TYPE>& other) { return this->getPointerAsInteger() + other.getPointerAsInteger(); }
		 ...
		 * @param value: Value to be assigned to the pointer.
		 */
		void operator=(const TYPE& value) { this->set((TYPE&&)value); }
