...
namespace Dynamik
{
    DMK_ALIGN_MAT4F class DMK_API Matrix4F;

    /* Vector 4D type traits */
    template <>
    struct DMK_ALIGN_MAT4F DMK_API MatrixTraits<Matrix4F>
    {
        typedef F32 type;
    };
    ...
    */
    DMK_ALIGN_MAT4F class DMK_API Matrix4F : public Matrix<Matrix4F>
    {
    public:
        Matrix4F();
        Matrix4F(F32 value);
