...
namespace Dynamik
{
    /*
     ...
     This class does not provide any functionality but used as a data container for different RBLs to store all
     the necessary data that is required to initialize, update, render and terminate a renderable object/ asset.
    */
